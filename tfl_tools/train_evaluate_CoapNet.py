...
LOG_FILE = os.path.join(MODEL_PATH, 'CoapNetDB1_75_32.out')
# -----------------------------

name='CoapNet'
input_width=32  # 32 64 128
input_height=32 # 32 64 128
input_channels=3
num_classes=7
...
momentum=0.9
keep_prob=0.75  # 1.0 without dropout and 0.5 with dropout
