...
#train_file, test_file = split_train_test()
print('building 32x32 dataset ...')
build_hd5(test_file, train_file, input_width = 32, input_height = 32, round='_db1')
print('done')
print('building 64x64 dataset ...')
build_hd5(test_file, train_file, input_width = 64, input_height = 64, round='_db1')
print('done')
print('building 128x128 dataset ...')
build_hd5(test_file, train_file, input_width = 128, input_height = 128, round='_db1')
print('done')
'''
