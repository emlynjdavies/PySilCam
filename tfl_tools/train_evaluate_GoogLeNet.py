...
for i in range(0,n_splits):
    ...
    out_test_hd5 = os.path.join(MODEL_PATH, 'image_set01_test' + str(input_width) + round_num + ".h5")
    out_train_hd5 = os.path.join(MODEL_PATH, 'image_set01_train' + str(input_width) + round_num + ".h5")
